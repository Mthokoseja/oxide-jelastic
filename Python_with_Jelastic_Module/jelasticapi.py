...
class JelasticAPI:
    ...
    def addContainerEnvVars(
        ...
        self.clear_envs()
    def createJpsProject(self, appid: str, envName: str, jps: str ) -> None:
        """
                Build Environment from Repo by Gerard
                """
        return self.japic._(
    ...
    def createEnvironment(self, appid: str, environment, nodes) -> None:
        """
                Greate Environment by Gerard
                """
        return self.japic._(
    ...
    def createEmptyEnvironment(self, appid: str, environment) -> None:
        """
                Greate Environment by Gerard
                """
        return self.japic._(
    ...
    def getEnvs(
        self, env: JelasticEnv,
    ) -> List[JelasticEnv]:
        """
        List environments by Gerard
        """
        return self.japic._(
